...
public class Menu {
    ...
    public void menuPrincipal(){
        ...
        System.out.println("4-Buscar quantidade de Vendas no Dia");
        ...
        switch (opcaoSelecionada){
            ...
            case 2 -> {
                try{
                    ...
                    this.registroVendas.registrarVendas(
                        this.calculadora.venda.qtdPlantas, this.calculadora.venda.getValorVenda(), this.calculadora.venda.getDescontosAplicados());
            ...
            case 4 -> {
                System.out.println("Informe a Data que você deseja buscar - Padrão (dd/mm/yyyy)");
                String data = this.scanner.nextLine();
                registroVendas.buscarQtdVendasDia(data);
                System.out.println("==============================================");
            }
