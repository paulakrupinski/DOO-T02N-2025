...
public class CalculadoraDark extends JFrame implements ActionListener {
    ...
    public CalculadoraDark() {
        ...
        btnModo.setIcon(new ImageIcon(CalculadoraDark.class.getResource("/image/Modobranco.png")));
        ...
        btnModo.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (blackMode) {
                    ...
                    btnModo.setIcon(new ImageIcon(CalculadoraDark.class.getResource("/image/Modopreto.png")));
    ...
    private double verificarExpressao(String expressao) {
        try {
            // essa expressao vai remover os espacos em branco e também os caracteres invalidos
            ...
            // aqui nois dividimos a expressao em partes separadas pelos operadores
